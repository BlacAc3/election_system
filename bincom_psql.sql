...
INSERT INTO agentname (name_id, firstname, lastname, email, phone, pollingunit_uniqueid) 
VALUES
...
CREATE TABLE IF NOT EXISTS announced_lga_results (
  ...
  date_entered TEXT NOT NULL, -- Store datetime as TEXT in PostgreSQL
  user_ip_address TEXT NOT NULL
);

-- Insert data into announced_lga_results
INSERT INTO announced_lga_results (result_id, lga_name, party_abbreviation, party_score, entered_by_user, date_entered, user_ip_address) 
VALUES
...
-- Insert data into announced_pu_results
...
-- Drop and create announced_state_results table
...
-- Drop and create announced_ward_results table
...
-- Insert data into lga
INSERT INTO lga (uniqueid, lga_id, lga_name, state_id, lga_description, entered_by_user, date_entered, user_ip_address) 
VALUES
...
-- Insert data into polling_unit
INSERT INTO polling_unit (uniqueid, polling_unit_id, ward_id, lga_id, uniquewardid, polling_unit_number, polling_unit_name, polling_unit_description, lat, long, entered_by_user, date_entered, user_ip_address) 
VALUES
